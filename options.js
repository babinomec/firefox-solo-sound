const els = {
  ...
  resumePrevious: document.getElementById('resumePrevious'),
...
function load(s) {
  ...
  els.resumePrevious.checked = s.resumePrevious;
...
function save() {
  ...
  const settings = {
    ...
    resumePrevious: els.resumePrevious.checked,
...
els.resumePrevious.addEventListener('change', save);
